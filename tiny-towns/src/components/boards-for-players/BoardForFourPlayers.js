...
export default function BoardForFourPlayers(props) {
    return (
        <div>
            ...
            <div class="game-container">
                ...
                <div>
                    <Board selectedResource={props.selectedResource} handleFinishTown={props.onFinishTown} player={2} />
                    <ResourceSelector handleSelectedResourceChange={props.onResourceSelect} />
                </div>
                <div>
                    <Board selectedResource={props.selectedResource} handleFinishTown={props.onFinishTown} player={3} />
                    <ResourceSelector handleSelectedResourceChange={props.onResourceSelect} />
                </div>
                <div>
                    <Board selectedResource={props.selectedResource} handleFinishTown={props.onFinishTown} player={4} />
                    <ResourceSelector handleSelectedResourceChange={props.onResourceSelect} />
                </div>
                <div>
                    <BuildingCards />
